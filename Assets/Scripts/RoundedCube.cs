...
public class RoundedCube : MonoBehaviour
{
	...
	private void CreateTriangles()
	{
		...
		mesh.subMeshCount = 1;
		var res = new int[trianglesX.Length + trianglesY.Length + trianglesZ.Length];
		trianglesX.CopyTo(res, 0);
		trianglesY.CopyTo(res, trianglesX.Length);
		trianglesZ.CopyTo(res, trianglesX.Length + trianglesY.Length);
		mesh.SetTriangles(res, 0);
		/* ----------- original code -----------
		//mesh.subMeshCount = 3;
		//mesh.SetTriangles(trianglesZ, 0);
		//mesh.SetTriangles(trianglesX, 0);
		//mesh.SetTriangles(trianglesY, 0);
		---------------------------------------- */
	}
